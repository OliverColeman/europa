 ...
 * @author O. J. Coleman
 */
public abstract class Population extends ConfigurableComponent {
	@Parameter(description = "The desired population size.", defaultValue = "100", minimumValue = "1")
	protected int desiredSize;

	@Parameter(description = "The class to use for Individuals. Must extend com.ojcoleman.europa.core.Individual.", defaultValue = "com.ojcoleman.europa.core.Individual")
	protected Class<Individual> individualClass;
	
	/**
	 * Constructor for {@link ConfigurableComponent}.
	 */
	public Population(ConfigurableComponent parentComponent, JsonObject componentConfig) throws Exception {
	 ...
	 */
	public abstract Set<Individual> getMembers();
