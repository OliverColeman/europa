 ...
 */
public class Base extends ComponentBase {
	...
	@Component(description = "Main component for the evolutionary run.", defaultClass = Run.class)
	Run run;

	public Base(ComponentBase parentComponent, Configuration componentConfig) throws Exception {
