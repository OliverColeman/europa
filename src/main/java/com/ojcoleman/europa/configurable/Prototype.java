 ...
 * configurable {@link PrototypeBase} object, e.g. via a JSON configuration file. The field must be of a type that
 * extends {@link PrototypeBase}. See {@link ConfigurableBase} and {@link PrototypeBase} for more information.
 * 
 * @see Configurable
 * @see Parameter
 * @see Component
